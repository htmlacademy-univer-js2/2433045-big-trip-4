    ...
    <form class="event event--edit" action="#" method="post">
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers">
          ...
          ${createOfferTemplate({ selectedOffers: offers, pointOffers})}
          </div>
        </section>
        <section class="event__section  event__section--destination">
          ...
          <div class="event__photos-tape">
            ${createImageTemplate({ destination: pointDestination })}
          </div>
        </div>
        </section>
      </section>
...
function createOfferTemplate({selectedOffers, pointOffers}) {
  return pointOffers.reduce((result, offer) =>
    ...
    <div class="event__offer-selector">
      <input class="event__offer-checkbox  visually-hidden" id="event-offer-luggage-1" type="checkbox" name="event-offer-luggage" ${selectedOffers.includes(offer.id) ? 'checked' : ''}>
...
function createImageTemplate({destination}) {
